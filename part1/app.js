...
(async () => {
  try {
    ...
    await db.execute(`
      ...
      ((SELECT dog_id FROM Dogs WHERE name = 'Rocky'), '2025-06-11 07:45:00', 60, 'City Gardens', 'open'),
      ((SELECT dog_id FROM Dogs WHERE name = 'Luna'), '2025-06-12 10:00:00', 30, 'Greenhill Reserve', 'open'),
